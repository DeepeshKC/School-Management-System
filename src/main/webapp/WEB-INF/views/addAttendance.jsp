	...
	<div class="row">
		<div class="col-lg-12">
			<div class="panel panel-default">
				<div class="panel-heading">Select Attendance info to add</div>

				<div class="panel-body">
					<div class="row">
						<div class="col-lg-offset-3 col-lg-6">
							<form:form name="qryform" method="POST"
								action="add-addAttendance" modelAttribute="attendance">
								...
								<button type="submit" class="btn btn-default">Control
									Attendance</button>
