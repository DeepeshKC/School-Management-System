							...
							<form:form name="qryform" method="POST" action="add-addTeacher"
								...
								<div class="form-group">
									...
									<form:input path="firstName" class="form-control"
										placeholder="Enter Teacher's First Name" required="required" />
								</div>
								<div class="form-group">
									<label>Please add last name</label>
									<form:input path="lastName" class="form-control"
										placeholder="Enter Teacher's Last Name" required="required" />
								</div>
								<div class="form-group">
									<label>Please add username</label>
									<form:input path="username" class="form-control"
										placeholder="Enter Teacher's Username" required="required" />
								</div>
								<div class="form-group">
